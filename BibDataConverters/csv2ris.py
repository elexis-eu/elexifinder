...
with open('D:/Lab_LexBib/BibMerge/lexno-elexifinder.csv', encoding="utf-8") as csvfile: # source file
...
with open('D:/Lab_LexBib/BibMerge/lexno-elexifinder.json', 'w', encoding="utf-8") as json_file: # result file
