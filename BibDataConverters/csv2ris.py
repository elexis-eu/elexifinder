...
with open('D:/Lab_LexBib/BibMerge/videos_locs.csv', encoding="utf-8") as csvfile: # source file
...
with open('D:/Lab_LexBib/BibMerge/videos_locs.json', 'w', encoding="utf-8") as json_file: # result file
