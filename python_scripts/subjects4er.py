...
try:
    with open('subjects_skos.json', encoding="utf-8") as f:
...
for item in bindings:
    ...
    keyextractlist.append({item['subject']['value'] : item['subjectLabel']['value']})
...
with open('erkeys.json', 'w', encoding="utf-8") as json_file:
	json.dump(erkeylist, json_file, indent=2)
with open('keyextractlist.json', 'w', encoding="utf-8") as json_file:
