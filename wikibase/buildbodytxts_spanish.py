...
with open(config.datafolder+'bodytxt/bodytxt_collection_spa.json', encoding="utf-8") as infile:
...
for row in sparqlresults:
	...
	if bodytxt:
		...
		with open(config.datafolder+'/bodytxt/bodytxt_spa_failed.txt', 'a', encoding="utf-8") as failed_list:
...
with open(config.datafolder+'bodytxt/bodytxt_collection_spa.json', 'w', encoding="utf-8") as json_file: # path to result JSON file
