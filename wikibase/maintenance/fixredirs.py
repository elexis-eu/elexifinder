...
for prop in props_to_check:
	...
	for row in sparqlresults:
		...
		statement = item[1].replace("http://lexbib.elex.is/entity/statement/","")
		redir = item[2].replace("http://lexbib.elex.is/entity/","")
		target = item[3].replace("http://lexbib.elex.is/entity/","")
